...
public class Starcraft
{
	...
	// public static ItemC14GaussRifle itemTest = (ItemC14GaussRifle) new
	// ItemC14GaussRifle().setFull3D()
	...
	public void init(FMLInitializationEvent event)
	{
		...
		// Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(itemTest,
		// 0, new ModelResourceLocation("starcraft:c14gaussrifle",
		// "inventory"));
	}
	...
	// ModelResourceLocation("starcraft:c14gaussrifle", "inventory"), new
	// RenderItemC14GaussRifle());
	// }
}
