...
<<<<<<< 9c53d1b268c91c7dd3e7b00933a509a597e4213d:src/main/java/ga/scmc/blocks/metablocks/BlockProtossMetalT3.java
=======
import scmc.blocks.ModBlocks;
import scmc.blocks.metablocks.EnumHandler.ProtossMetalType;
import scmc.lib.Reference;
>>>>>>> Start of proxy rebuild:src/main/java/scmc/blocks/metablocks/BlockProtossMetalT3.java

/**
 * This block has three variants. Refer to {@link ProtossMetalType}
 */
public class BlockProtossMetalT3 extends ModBlocks implements IMetaBlockName {
	...
	public BlockProtossMetalT3() {
		...
		setUnlocalizedName(Reference.ModBlocks.BLOCK_PROTOSS_METALT3.getUnlocalizedName());
		setRegistryName(Reference.ModBlocks.BLOCK_PROTOSS_METALT3.getRegistryRL());
		setHardness(5.0F);
		setResistance(25.0F);
