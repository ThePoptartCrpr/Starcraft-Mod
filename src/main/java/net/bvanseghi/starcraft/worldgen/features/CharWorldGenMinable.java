...
public class CharWorldGenMinable extends WorldGenerator
{
    ...
    {
        this(p_i45459_1_, p_i45459_2_, ModBlocks.stoneChar);
    }

    public CharWorldGenMinable(Block p_i45460_1_, int p_i45460_2_, Block p_i45460_3_)
    {
    ...
    public CharWorldGenMinable(Block block, int meta, int number, Block target)
    {
