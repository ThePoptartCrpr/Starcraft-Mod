...
public class StructureVespeneGeyser extends WorldGenerator {
	...
	public boolean generate_r0(World world, Random rand, BlockPos pos) {
		...
		world.setBlockState(pos.add(x + 1, y + 1, z + 1), ModBlocks.VESPENE_GEYSER.getDefaultState());
		...
		world.setBlockState(pos.add(x + 5, y + 1, z + 1), ModBlocks.VESPENE_GEYSER.getDefaultState());
		...
		world.setBlockState(pos.add(x + 3, y + 2, z + 2), ModBlocks.VESPENE_GEYSER.getDefaultState());
