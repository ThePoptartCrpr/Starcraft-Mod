...
{
    private static final ResourceLocation ZERGLINGSWARMLING_LAYER = new ResourceLocation(Reference.RL_BASE + "textures/entity/zerglingswarmling_layer.png");
