...
public class ItemProtossVoidCyberneticsCoreSpawner extends ModItems {
	...
	public ItemProtossVoidCyberneticsCoreSpawner() {
		setUnlocalizedName(Reference.ModItems.ITEM_SPAWNER_PROTOSS_VOID_CYBERNETICSCORE.getUnlocalizedName());
		setRegistryName(Reference.ModItems.ITEM_SPAWNER_PROTOSS_VOID_CYBERNETICSCORE.getRegistryRL());
	}
