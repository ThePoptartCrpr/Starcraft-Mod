...
public class ItemIngotT3 extends Item {
	 ...
	 */
	public ItemIngotT3() {
		this.setUnlocalizedName(Reference.ModItems.ITEM_INGOT3.getUnlocalizedName());
		this.setRegistryName(Reference.ModItems.ITEM_INGOT3.getRegistryRL());
