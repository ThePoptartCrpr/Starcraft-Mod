...
public class StructureMineralBed extends WorldGenerator {
	...
	public boolean generate_r0(World world, Random rand, int x, int y, int z) {
		...
		world.setBlock(x + 10, y + 0, z + 0, ModBlocks.mineralField, 0, 3);
		world.setBlock(x + 0, y + 0, z + 1, ModBlocks.mineralField, 0, 3);
		...
		world.setBlock(x + 7, y + 0, z + 1, ModBlocks.mineralField, 0, 3);
		world.setBlock(x + 8, y + 0, z + 1, Blocks.air, 0, 3);
		world.setBlock(x + 9, y + 0, z + 1, ModBlocks.mineralField, 0, 3);
		world.setBlock(x + 10, y + 0, z + 1, ModBlocks.mineralField, 0, 3);
		world.setBlock(x + 0, y + 0, z + 2, Blocks.air, 0, 3);
		world.setBlock(x + 1, y + 0, z + 2, ModBlocks.mineralField, 0, 3);
		world.setBlock(x + 2, y + 0, z + 2, Blocks.air, 0, 3);
		world.setBlock(x + 3, y + 0, z + 2, ModBlocks.mineralField, 0, 3);
		world.setBlock(x + 4, y + 0, z + 2, Blocks.air, 0, 3);
		world.setBlock(x + 5, y + 0, z + 2, ModBlocks.mineralField, 0, 3);
		...
		world.setBlock(x + 3, y + 0, z + 3, ModBlocks.mineralField, 0, 3);
		world.setBlock(x + 4, y + 0, z + 3, ModBlocks.mineralField, 0, 3);
		world.setBlock(x + 5, y + 0, z + 3, Blocks.air, 0, 3);
		world.setBlock(x + 6, y + 0, z + 3, ModBlocks.mineralField, 0, 3);
		world.setBlock(x + 7, y + 0, z + 3, Blocks.air, 0, 3);
		world.setBlock(x + 8, y + 0, z + 3, ModBlocks.mineralField, 0, 3);
