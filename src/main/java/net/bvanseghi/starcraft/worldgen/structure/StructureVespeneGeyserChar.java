...
public class StructureVespeneGeyserChar extends WorldGenerator {
	...
	public boolean generate_r0(World world, Random rand, int x, int y, int z) {
		...
		world.setBlock(x + 1, y + 1, z + 1, ModBlocks.vespeneGeyserChar, 0, 3);
		...
		world.setBlock(x + 5, y + 1, z + 1, ModBlocks.vespeneGeyserChar, 0, 3);
		...
		world.setBlock(x + 3, y + 2, z + 2, ModBlocks.vespeneGeyserChar, 0, 3);
