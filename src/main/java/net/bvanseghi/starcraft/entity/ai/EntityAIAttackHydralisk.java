...
{
    private final EntityHydralisk entity;
    ...
    public EntityAIAttackHydralisk(EntityHydralisk hydralisk, double speedAmplifier, int delay, float maxDistance)
    {
        this.entity = hydralisk;
