...
public class SteelDust implements IRecipe {
	...
	/**
	 * <i>I typically null this method because I've never seen any reason to use
	 * it. It's supposed to be used as a "general form" for crafting output.
	 * Typically it isn't necessary, and usually I only use IRecipe for complex
	 * recipes, so I rarely get to use this regardless. Here I can use it as our
	 * output is always "general" in a sense</i><br>
	 * <br>
	 ...
	 * @see net.minecraft.item.crafting.IRecipe#matches(InventoryCrafting,
	 * World)
	 */
	@Override
