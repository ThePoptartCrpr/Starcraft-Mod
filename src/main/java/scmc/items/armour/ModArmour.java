...
public class ModArmour {
	...
	// Protoss armors
	static final ItemArmor.ArmorMaterial ADEPT_ARMOUR_MATERIAL_T1 = EnumHelper.addArmorMaterial("adeptArmorMaterialT1", Reference.RL_BASE + "adeptT1", 33,
			new int[] { 3, 8, 6, 3 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0f);
	static final ItemArmor.ArmorMaterial ADEPT_ARMOUR_MATERIAL_T2 = EnumHelper.addArmorMaterial("adeptArmorMaterialT2", Reference.RL_BASE + "adeptT2", 35,
			new int[] { 4, 9, 7, 4 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0f);
	static final ItemArmor.ArmorMaterial ADEPT_ARMOUR_MATERIAL_T3 = EnumHelper.addArmorMaterial("adeptArmorMaterialT3", Reference.RL_BASE + "adeptT3", 37,
	...
	static final ItemArmor.ArmorMaterial KHAYDARIN_AMULET_ARMOUR_MATERIAL = EnumHelper.addArmorMaterial("khaydarinAmuletArmorMaterial", Reference.RL_BASE + "khaydarin_amulet",
			37, new int[] { 5, 10, 8, 5 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0f);
	static final ItemArmor.ArmorMaterial STEEL_ARMOUR_MATERIAL = EnumHelper.addArmorMaterial("steelArmorMaterial", Reference.RL_BASE + "steel", 29, new int[] { 3, 7, 5, 3 },
			9, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0f);
	static final ItemArmor.ArmorMaterial TITANIUM_ARMOUR_MATERIAL = EnumHelper.addArmorMaterial("titaniumArmorMaterial", Reference.RL_BASE + "titanium", 21,
			new int[] { 3, 6, 5, 2 }, 30, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0f);
	static final ItemArmor.ArmorMaterial ZEALOT_ARMOUR_MATERIAL_T1 = EnumHelper.addArmorMaterial("zealotArmorMaterialT1", Reference.RL_BASE + "zealotT1", 33,
			new int[] { 3, 8, 6, 3 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0f);
	static final ItemArmor.ArmorMaterial ZEALOT_ARMOUR_MATERIAL_T2 = EnumHelper.addArmorMaterial("zealotArmorMaterialT2", Reference.RL_BASE + "zealotT2", 35,
			new int[] { 4, 9, 7, 4 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0f);
	static final ItemArmor.ArmorMaterial ZEALOT_ARMOUR_MATERIAL_T3 = EnumHelper.addArmorMaterial("zealotArmorMaterialT3", Reference.RL_BASE + "zealotT3", 37,
			new int[] { 5, 10, 8, 5 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0f);
	...
	public static final Item[] ARMOURS = { titaniumHelmet, titaniumChestplate, titaniumLeggings, titaniumBoots, copperHelmet, copperChestplate, copperLeggings, copperBoots,
	...
	public static void init() {
		...
		adeptHelmetT1 = new ArmorAdeptHelmetT1(ADEPT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.HEAD);
		adeptChestplateT1 = new ArmorAdeptChestplateT1(ADEPT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.CHEST);
		adeptLeggingsT1 = new ArmorAdeptLeggingsT1(ADEPT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.LEGS);
		adeptBootsT1 = new ArmorAdeptBootsT1(ADEPT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.FEET);

		adeptHelmetT2 = new ArmorAdeptHelmetT2(ADEPT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.HEAD);
		adeptChestplateT2 = new ArmorAdeptChestplateT2(ADEPT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.CHEST);
		adeptLeggingsT2 = new ArmorAdeptLeggingsT2(ADEPT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.LEGS);
		adeptBootsT2 = new ArmorAdeptBootsT2(ADEPT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.FEET);

		adeptHelmetT3 = new ArmorAdeptHelmetT3(ADEPT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.HEAD);
		adeptChestplateT3 = new ArmorAdeptChestplateT3(ADEPT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.CHEST);
		adeptLeggingsT3 = new ArmorAdeptLeggingsT3(ADEPT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.LEGS);
		adeptBootsT3 = new ArmorAdeptBootsT3(ADEPT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.FEET);

		zealotHelmetT1 = new ArmorZealotHelmetT1(ZEALOT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.HEAD);
		zealotChestplateT1 = new ArmorZealotChestplateT1(ZEALOT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.CHEST);
		zealotLeggingsT1 = new ArmorZealotLeggingsT1(ZEALOT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.LEGS);
		zealotBootsT1 = new ArmorZealotBootsT1(ZEALOT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.FEET);

		zealotHelmetT2 = new ArmorZealotHelmetT2(ZEALOT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.HEAD);
		zealotChestplateT2 = new ArmorZealotChestplateT2(ZEALOT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.CHEST);
		zealotLeggingsT2 = new ArmorZealotLeggingsT2(ZEALOT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.LEGS);
		zealotBootsT2 = new ArmorZealotBootsT2(ZEALOT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.FEET);

		zealotHelmetT3 = new ArmorZealotHelmetT3(ZEALOT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.HEAD);
		zealotChestplateT3 = new ArmorZealotChestplateT3(ZEALOT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.CHEST);
		zealotLeggingsT3 = new ArmorZealotLeggingsT3(ZEALOT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.LEGS);
		zealotBootsT3 = new ArmorZealotBootsT3(ZEALOT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.FEET);

		purifierAdeptHelmetT1 = new ArmorPurifierAdeptHelmetT1(ADEPT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.HEAD);
		purifierAdeptChestplateT1 = new ArmorPurifierAdeptChestplateT1(ADEPT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.CHEST);
		purifierAdeptLeggingsT1 = new ArmorPurifierAdeptLeggingsT1(ADEPT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.LEGS);
		purifierAdeptBootsT1 = new ArmorPurifierAdeptBootsT1(ADEPT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.FEET);

		purifierAdeptHelmetT2 = new ArmorPurifierAdeptHelmetT2(ADEPT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.HEAD);
		purifierAdeptChestplateT2 = new ArmorPurifierAdeptChestplateT2(ADEPT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.CHEST);
		purifierAdeptLeggingsT2 = new ArmorPurifierAdeptLeggingsT2(ADEPT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.LEGS);
		purifierAdeptBootsT2 = new ArmorPurifierAdeptBootsT2(ADEPT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.FEET);

		purifierAdeptHelmetT3 = new ArmorPurifierAdeptHelmetT3(ADEPT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.HEAD);
		purifierAdeptChestplateT3 = new ArmorPurifierAdeptChestplateT3(ADEPT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.CHEST);
		purifierAdeptLeggingsT3 = new ArmorPurifierAdeptLeggingsT3(ADEPT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.LEGS);
		purifierAdeptBootsT3 = new ArmorPurifierAdeptBootsT3(ADEPT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.FEET);

		darkZealotHelmetT1 = new ArmorDarkZealotHelmetT1(ZEALOT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.HEAD);
		darkZealotChestplateT1 = new ArmorDarkZealotChestplateT1(ZEALOT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.CHEST);
		darkZealotLeggingsT1 = new ArmorDarkZealotLeggingsT1(ZEALOT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.LEGS);
		darkZealotBootsT1 = new ArmorDarkZealotBootsT1(ZEALOT_ARMOUR_MATERIAL_T1, 0, EntityEquipmentSlot.FEET);

		darkZealotHelmetT2 = new ArmorDarkZealotHelmetT2(ZEALOT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.HEAD);
		darkZealotChestplateT2 = new ArmorDarkZealotChestplateT2(ZEALOT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.CHEST);
		darkZealotLeggingsT2 = new ArmorDarkZealotLeggingsT2(ZEALOT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.LEGS);
		darkZealotBootsT2 = new ArmorDarkZealotBootsT2(ZEALOT_ARMOUR_MATERIAL_T2, 0, EntityEquipmentSlot.FEET);

		darkZealotHelmetT3 = new ArmorDarkZealotHelmetT3(ZEALOT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.HEAD);
		darkZealotChestplateT3 = new ArmorDarkZealotChestplateT3(ZEALOT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.CHEST);
		darkZealotLeggingsT3 = new ArmorDarkZealotLeggingsT3(ZEALOT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.LEGS);
		darkZealotBootsT3 = new ArmorDarkZealotBootsT3(ZEALOT_ARMOUR_MATERIAL_T3, 0, EntityEquipmentSlot.FEET);

		khaydarinAmulet = new ArmorKhaydarinAmulet(KHAYDARIN_AMULET_ARMOUR_MATERIAL, 0, EntityEquipmentSlot.HEAD);
		darkKhaydarinAmulet = new ArmorDarkKhaydarinAmulet(KHAYDARIN_AMULET_ARMOUR_MATERIAL, 0, EntityEquipmentSlot.HEAD);
	}
