...
public class ModRecipes {
	...
	public static void init() {
		...
		GameRegistry.addRecipe(new ItemStack(ModMetaBlocks.PROTOSS_METAL_T1, 1, 0),
				new Object[] { "AAA", "AAA", "AAA", 'A', new ItemStack(ModItems.ingot1, 0, 1) });

		GameRegistry.addRecipe(new ItemStack(ModMetaBlocks.PROTOSS_METAL_T1, 1, 1),
				new Object[] { "DDD", "DDD", "DDD", 'D', new ItemStack(ModItems.ingot1, 0, 2) });

		GameRegistry.addRecipe(new ItemStack(ModBlocks.ENERGY_BLOCK),
				new Object[] { "EEE", "EEE", "EEE", 'E', new ItemStack(ModItems.energy, 0, 0) });

		GameRegistry.addRecipe(new ItemStack(ModBlocks.VOID_ENERGY_BLOCK),
				new Object[] { "VVV", "VVV", "VVV", 'V', new ItemStack(ModItems.energy, 0, 2) });

		GameRegistry.addRecipe(new ItemStack(ModBlocks.COMP_METAL, 1, 1),
				new Object[] { "TTT", "TTT", "TTT", 'T', new ItemStack(ModItems.ingot1, 0, 3) });

		GameRegistry.addRecipe(new ItemStack(ModBlocks.COMP_METAL, 1, 0),
				new Object[] { "CCC", "CCC", "CCC", 'C', new ItemStack(ModItems.ingot1, 0, 0) });

		GameRegistry.addRecipe(new ItemStack(ModBlocks.COMP_METAL, 1, 2),
				new Object[] { "SSS", "SSS", "SSS", 'S', new ItemStack(ModItems.ingot1, 0, 4) });
		...
		GameRegistry.addRecipe(new ItemStack(ModBlocks.PROTOSS_WARPPROJECTOR_CHAR),
				new Object[] { "AEA", "ACA", "AMA", 'A', new ItemStack(ModMetaBlocks.PROTOSS_METAL_T1, 1, 0), 'E',
		...
		GameRegistry.addRecipe(new ItemStack(ModBlocks.PROTOSS_WARPPROJECTOR_SHAKURAS),
				new Object[] { "AEA", "ASA", "AMA", 'A', new ItemStack(ModMetaBlocks.PROTOSS_METAL_T1, 1, 0), 'E',
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.protossModule),
				new Object[] { "AEA", "ADA", "AEA", 'A', new ItemStack(ModItems.ingot1, 1, 1), 'E',
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.ingot1, 9, 2),
				new Object[] { "D", 'D', new ItemStack(ModMetaBlocks.PROTOSS_METAL_T1, 1, 1) });

		GameRegistry.addRecipe(new ItemStack(ModItems.ingot1, 9, 1),
				new Object[] { "A", 'A', new ItemStack(ModMetaBlocks.PROTOSS_METAL_T1, 1, 0) });
		...
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.ingot1, 1, 2),
				new Object[] { new ItemStack(Items.DYE, 0, 0), new ItemStack(ModItems.ingot1, 0, 1) });

		GameRegistry.addRecipe(new ItemStack(ModItems.psiBladeFocuserUncharged),
				new Object[] { " A ", "A A", " AA", 'A', new ItemStack(ModItems.ingot1, 0, 1) });
		GameRegistry.addRecipe(new ItemStack(ModItems.darkPsiBladeFocuserUncharged),
				new Object[] { " D ", "D D", " DD", 'D', new ItemStack(ModItems.ingot1, 0, 2) });

		GameRegistry.addRecipe(new ItemStack(ModItems.ingot1, 9, 3),
				new Object[] { "T", 'T', new ItemStack(ModBlocks.COMP_METAL, 1, 1) });

		GameRegistry.addRecipe(new ItemStack(ModItems.ingot1, 9, 0),
				new Object[] { "C", 'C', new ItemStack(ModBlocks.COMP_METAL, 1, 0) });

		GameRegistry.addRecipe(new ItemStack(ModItems.ingot1, 9, 4),
				new Object[] { "S", 'S', new ItemStack(ModBlocks.COMP_METAL, 1, 2) });
		...
		GameRegistry.addSmelting(new ItemStack(ModBlocks.COBBLESTONE_SHAKURAS), new ItemStack(ModBlocks.STONE_SHAKURAS),
				0);
		GameRegistry.addRecipe(new ItemStack(Blocks.FURNACE),
				new Object[] { "###", "# #", "###", '#', ModBlocks.COBBLESTONE_SHAKURAS });

		GameRegistry.addSmelting(new ItemStack(ModBlocks.COBBLESTONE_CHAR), new ItemStack(ModBlocks.STONE_CHAR), 0);
		GameRegistry.addRecipe(new ItemStack(Blocks.FURNACE),
				new Object[] { "###", "# #", "###", '#', ModBlocks.COBBLESTONE_CHAR });
		...
		GameRegistry.addRecipe(new ItemStack(ModWeapons.PSI_BLADE), new Object[] { " A ", "AEA", " AA", 'A',
				new ItemStack(ModItems.ingot1, 0, 1), 'E', new ItemStack(ModItems.energy, 0, 0) });
		...
		GameRegistry.addRecipe(new ItemStack(ModWeapons.WARP_BLADE), new Object[] { " A ", "ACA", " AA", 'A',
				new ItemStack(ModItems.ingot1, 0, 1), 'C', new ItemStack(ModItems.energy, 0, 1) });
		...
		GameRegistry.addRecipe(new ItemStack(ModWeapons.DARK_PSI_BLADE), new Object[] { " D ", "DVD", " DD", 'D',
				new ItemStack(ModItems.ingot1, 0, 2), 'V', new ItemStack(ModItems.energy, 0, 2) });
		...
		GameRegistry.addRecipe(new ItemStack(ModWeapons.DARK_WARP_BLADE), new Object[] { " D ", "DCD", " DD", 'D',
				new ItemStack(ModItems.ingot1, 0, 2), 'C', new ItemStack(ModItems.energy, 0, 1) });
		...
		GameRegistry.addRecipe(new ItemStack(ModTools.COPPER_SHOVEL),
				new Object[] { " C ", " S ", " S ", 'C', new ItemStack(ModItems.ingot1, 0, 0), 'S', Items.STICK });
		GameRegistry.addRecipe(new ItemStack(ModTools.COPPER_AXE),
				new Object[] { " CC", " SC", " S ", 'C', new ItemStack(ModItems.ingot1, 0, 0), 'S', Items.STICK });
		GameRegistry.addRecipe(new ItemStack(ModTools.COPPER_PICKAXE),
				new Object[] { "CCC", " S ", " S ", 'C', new ItemStack(ModItems.ingot1, 0, 0), 'S', Items.STICK });
		GameRegistry.addRecipe(new ItemStack(ModTools.COPPER_HOE),
				new Object[] { " CC", " S ", " S ", 'C', new ItemStack(ModItems.ingot1, 0, 0), 'S', Items.STICK });
		GameRegistry.addRecipe(new ItemStack(ModWeapons.COPPER_SWORD),
				new Object[] { " C ", " C ", " S ", 'C', new ItemStack(ModItems.ingot1, 0, 0), 'S', Items.STICK });

		GameRegistry.addRecipe(new ItemStack(ModArmour.copperHelmet),
				new Object[] { "CCC", "C C", "   ", 'C', new ItemStack(ModItems.ingot1, 0, 0) });
		GameRegistry.addRecipe(new ItemStack(ModArmour.copperChestplate),
				new Object[] { "C C", "CCC", "CCC", 'C', new ItemStack(ModItems.ingot1, 0, 0) });
		GameRegistry.addRecipe(new ItemStack(ModArmour.copperLeggings),
				new Object[] { "CCC", "C C", "C C", 'C', new ItemStack(ModItems.ingot1, 0, 0) });
		GameRegistry.addRecipe(new ItemStack(ModArmour.copperBoots),
				new Object[] { "   ", "C C", "C C", 'C', new ItemStack(ModItems.ingot1, 0, 0) });

		GameRegistry.addRecipe(new ItemStack(ModTools.STEEL_SHOVEL),
				new Object[] { " S ", " I ", " I ", 'S', new ItemStack(ModItems.ingot1, 0, 4), 'I', Items.STICK });
		GameRegistry.addRecipe(new ItemStack(ModTools.STEEL_AXE),
				new Object[] { " SS", " IS", " I ", 'S', new ItemStack(ModItems.ingot1, 0, 4), 'I', Items.STICK });
		GameRegistry.addRecipe(new ItemStack(ModTools.STEEL_PICKAXE),
				new Object[] { "SSS", " I ", " I ", 'S', new ItemStack(ModItems.ingot1, 0, 4), 'I', Items.STICK });
		GameRegistry.addRecipe(new ItemStack(ModTools.STEEL_HOE),
				new Object[] { " SS", " I ", " I ", 'S', new ItemStack(ModItems.ingot1, 0, 4), 'I', Items.STICK });
		GameRegistry.addRecipe(new ItemStack(ModWeapons.STEEL_SWORD),
				new Object[] { " S ", " S ", " I ", 'S', new ItemStack(ModItems.ingot1, 0, 4), 'I', Items.STICK });

		GameRegistry.addRecipe(new ItemStack(ModArmour.steelHelmet),
				new Object[] { "SSS", "S S", "   ", 'S', new ItemStack(ModItems.ingot1, 0, 4) });
		GameRegistry.addRecipe(new ItemStack(ModArmour.steelChestplate),
				new Object[] { "S S", "SSS", "SSS", 'S', new ItemStack(ModItems.ingot1, 0, 4) });
		GameRegistry.addRecipe(new ItemStack(ModArmour.steelLeggings),
				new Object[] { "SSS", "S S", "S S", 'S', new ItemStack(ModItems.ingot1, 0, 4) });
		GameRegistry.addRecipe(new ItemStack(ModArmour.steelBoots),
				new Object[] { "   ", "S S", "S S", 'S', new ItemStack(ModItems.ingot1, 0, 4) });

		GameRegistry.addRecipe(new ItemStack(ModTools.TITANIUM_SHOVEL),
				new Object[] { " T ", " S ", " S ", 'T', new ItemStack(ModItems.ingot1, 0, 3), 'S', Items.STICK });
		GameRegistry.addRecipe(new ItemStack(ModTools.TITANIUM_AXE),
				new Object[] { " TT", " ST", " S ", 'T', new ItemStack(ModItems.ingot1, 0, 3), 'S', Items.STICK });
		GameRegistry.addRecipe(new ItemStack(ModTools.TITANIUM_PICKAXE),
				new Object[] { "TTT", " S ", " S ", 'T', new ItemStack(ModItems.ingot1, 0, 3), 'S', Items.STICK });
		GameRegistry.addRecipe(new ItemStack(ModTools.TITANIUM_HOE),
				new Object[] { " TT", " S ", " S ", 'T', new ItemStack(ModItems.ingot1, 0, 3), 'S', Items.STICK });
		GameRegistry.addRecipe(new ItemStack(ModWeapons.TITANIUM_SWORD),
				new Object[] { " T ", " T ", " S ", 'T', new ItemStack(ModItems.ingot1, 0, 3), 'S', Items.STICK });

		GameRegistry.addRecipe(new ItemStack(ModArmour.titaniumHelmet),
				new Object[] { "TTT", "T T", "   ", 'T', new ItemStack(ModItems.ingot1, 0, 3) });
		GameRegistry.addRecipe(new ItemStack(ModArmour.titaniumChestplate),
				new Object[] { "T T", "TTT", "TTT", 'T', new ItemStack(ModItems.ingot1, 0, 3) });
		GameRegistry.addRecipe(new ItemStack(ModArmour.titaniumLeggings),
				new Object[] { "TTT", "T T", "T T", 'T', new ItemStack(ModItems.ingot1, 0, 3) });
		GameRegistry.addRecipe(new ItemStack(ModArmour.titaniumBoots),
				new Object[] { "   ", "T T", "T T", 'T', new ItemStack(ModItems.ingot1, 0, 3) });

		GameRegistry.addRecipe(new ItemStack(ModItems.bullet, 6),
				new Object[] { " S ", " P ", " S ", 'S', new ItemStack(ModItems.ingot1, 0, 4), 'P', Items.GUNPOWDER });

		GameRegistry.addRecipe(new ItemStack(ModItems.c14Parts, 1, 0), new Object[] { "SSS", "STT", "S  ", 'S',
				new ItemStack(ModItems.ingot1, 0, 4), 'T', new ItemStack(ModItems.ingot1, 0, 3) });
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.c14Parts, 1, 2),
				new Object[] { "SS ", "S S", "SSS", 'S', new ItemStack(ModItems.ingot1, 0, 4) });
		...
		GameRegistry.addRecipe(new ItemStack(ModItems.vespene, 1, 0), new Object[] { " A ", "AVA", " A ", 'A',
				new ItemStack(ModItems.ingot1, 0, 1), 'V', new ItemStack(ModItems.vespene, 0, 3) });
