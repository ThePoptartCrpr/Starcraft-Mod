...
<<<<<<< 9c53d1b268c91c7dd3e7b00933a509a597e4213d:src/main/java/ga/scmc/blocks/metablocks/BlockProtossMetalT1.java
=======
import scmc.blocks.ModBlocks;
import scmc.blocks.metablocks.EnumHandler.ProtossMetalType;
import scmc.lib.Reference;
>>>>>>> Start of proxy rebuild:src/main/java/scmc/blocks/metablocks/BlockProtossMetalT1.java
...
public class BlockProtossMetalT1 extends ModBlocks implements IMetaBlockName {
	...
	public BlockProtossMetalT1() {
		...
		setUnlocalizedName(Reference.ModBlocks.BLOCK_PROTOSS_METALT1.getUnlocalizedName());
		setRegistryName(Reference.ModBlocks.BLOCK_PROTOSS_METALT1.getRegistryRL());
		setHardness(5.0F);
		setResistance(25.0F);
