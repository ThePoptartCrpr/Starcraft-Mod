...
public class DimensionRegistry {
	...
	public static final int CHAR_DIMENSION_ID = StarcraftConfig.INT_DIMENSION_CHAR;
	...
	public static final int SHAKURAS_DIMENSION_ID = StarcraftConfig.INT_DIMENSION_SHAKURAS;
