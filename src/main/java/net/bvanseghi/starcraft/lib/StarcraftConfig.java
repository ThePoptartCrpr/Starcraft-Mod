...
public class StarcraftConfig {
	...
	public static void preInit() {
		...
		useSubCfg = config.getBoolean("Use Sub-Config", "General", false, "If true, the sub-config \'./scmc_editor/units.cfg\' will be used to set various mob stats. NOTE: if there's nothing in units.cfg and you wish to use it, run the game once with this true to populate the file");
