...
public class ChunkProviderShakuras extends ChunkProviderGenerate implements IChunkProvider {
	/** RNG. */
	private Random rand;
	...
	public boolean mapGenStructures;
	...
	public ChunkProviderShakuras(World world, long par1, boolean par2) {
