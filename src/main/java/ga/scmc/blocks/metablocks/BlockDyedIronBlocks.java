...
import ga.scmc.blocks.metablocks.EnumHandler.DyedIronType;
...
<<<<<<< 9c53d1b268c91c7dd3e7b00933a509a597e4213d:src/main/java/ga/scmc/blocks/metablocks/BlockDyedIronBlocks.java
=======
import scmc.blocks.ModBlocks;
import scmc.blocks.metablocks.EnumHandler.DyedIronType;
import scmc.lib.Reference;
>>>>>>> Start of proxy rebuild:src/main/java/scmc/blocks/metablocks/BlockDyedIronBlocks.java
...
public class BlockDyedIronBlocks extends ModBlocks implements IMetaBlockName {
	...
	public int getMetaFromState(IBlockState state) {
		DyedIronType type = state.getValue(TYPE);
		return type.getID();
	}
	...
	public void getSubBlocks(Item itemIn, CreativeTabs tab, List<ItemStack> list) {
		for(int i = 0; i < DyedIronType.values().length; i++) {
