...
public class ModBlocks extends Block {
	...
	public static void init() {
		...
		/*
		 * ORE_TITANIUM_OW = new OreOWTitanium(); ORE_URANIUM_OW = new
		 * OreOWUranium();
		 * 
		 * ORE_ALIEN_CHAR = new OreCharAlien(); ORE_COAL_CHAR = new
		 * OreCharCoal(); ORE_COPPER_CHAR = new OreCharCopper();
		 * ORE_DIAMOND_CHAR = new OreCharDiamond(); ORE_GOLD_CHAR = new
		 * OreCharGold(); ORE_IRON_CHAR = new OreCharIron(); ORE_LAPIS_CHAR =
		 * new OreCharLapis(); ORE_MINERAL_CHAR = new OreCharMineral();
		 * ORE_REDSTONE_CHAR = new OreCharRedstone(); ORE_RICHMINERAL_CHAR = new
		 * OreCharRichMineral(); ORE_TITANIUM_CHAR = new OreCharTitanium();
		 * 
		 * ORE_ALIEN_SHAKURAS = new OreShakurasAlien(); ORE_COAL_SHAKURAS = new
		 * OreShakurasCoal(); ORE_COPPER_SHAKURAS = new OreShakurasCopper();
		 * ORE_DIAMOND_SHAKURAS = new OreShakurasDiamond(); ORE_GOLD_SHAKURAS =
		 * new OreShakurasGold(); ORE_IRON_SHAKURAS = new OreShakurasIron();
		 * ORE_LAPIS_SHAKURAS = new OreShakurasLapis(); ORE_MINERAL_SHAKURAS =
		 * new OreShakurasMineral(); ORE_REDSTONE_SHAKURAS = new
		 * OreShakurasRedstone(); ORE_RICHMINERAL_SHAKURAS = new
		 * OreShakurasRichMineral(); ORE_TITANIUM_SHAKURAS = new
		 * OreShakurasTitanium();
		 * 
		 * COMP_MINERAL = new BlockCompressedMinerals(); CRYSTAL = new
		 * BlockPylonCrystal(); ZERG_STRUCTURE_CARAPACE = new
		 * BlockZergStructureCarapace(); ZERG_STRUCTURE_FLESH = new
		 * BlockZergStructureFlesh(); COMP_METAL = new BlockCompressedMetals();
		 * PROTOSS_METAL = new BlockProtossMetal(); DYED_IRON = new
		 * BlockDyedIronBlocks();
		 * 
		 * 
		 * PROTOSS_ENERGY_STABILIZER = new BlockProtossEnergyStabilizer();
		 * PROTOSS_ENERGY_CHANNEL = new BlockProtossEnergyChannel();
		 * PROTOSS_DARK_ENERGY_STABILIZER = new
		 * BlockProtossEnergyStabilizerDark(); PROTOSS_DARK_ENERGY_CHANNEL = new
		 * BlockProtossEnergyChannelDark();
		 * 
		 * ENERGY_BLOCK = new BlockEnergyBlock(); VOID_ENERGY_BLOCK = new
		 * BlockVoidEnergyBlock(); WARPGATE_WORMHOLE_CHAR = new
		 * BlockWarpGateWormholeChar(Material.GROUND);
		 * WARPGATE_WORMHOLE_OVERWORLD = new
		 * BlockWarpGateWormholeOverworld(Material.GROUND);
		 * WARPGATE_WORMHOLE_SHAKURAS = new
		 * BlockWarpGateWormholeShakuras(Material.GROUND);
		 * 
		 ...
		 * RICH_VESPENE_GEYSER_CHAR = new
		 * BlockRichVespeneGeyserChar(Material.GROUND); VESPENE_GEYSER_SHAKURAS
		 * = new BlockVespeneGeyserShakuras(Material.GROUND);
		 * RICH_VESPENE_GEYSER_SHAKURAS = new
		 * BlockRichVespeneGeyserShakuras(Material.GROUND);
		 * 
		 ...
		 * 
		 * ZERG_CREEP = new BlockZergCreep(); KERATIN_CHUNK = new
		 * BlockKeratinChunk();
		 * 
		 ...
		 * 
		 * 
		 * ASH_CHAR = new BlockAsh(); DIRT_CHAR = new BlockCharDirt();
		 * STONE_CHAR = new BlockCharStone(); COBBLESTONE_CHAR = new
		 * BlockCharCobblestone(); MAGMA_CHAR = new BlockCharMagma();
		 * 
		 * SAND_SHAKURAS = new BlockShakurasSand(); STONE_SHAKURAS = new
		 * BlockShakurasStone(); COBBLESTONE_SHAKURAS = new
		 * BlockShakurasCobblestone();
		 * 
		 * DIM_PORTAL_CHAR = new DimPortalChar(); DIM_PORTAL_OVERWORLD = new
		 * DimPortalOverworld(); DIM_PORTAL_SHAKURAS = new DimPortalShakuras();
		 */
	}
	...
	public static void register() {
		 ...
		 * GameRegistry.register(COMP_MINERAL); GameRegistry.register(CRYSTAL);
		 * 
		 ...
		 * GameRegistry.register(ASH_CHAR); GameRegistry.register(DIRT_CHAR);
		 ...
		 * 
		 * GameRegistry.register(COMP_METAL); GameRegistry.register(DYED_IRON);
		 */
	}
	...
	public static void registerRenders() {
		...
		/*
		 * registerRender(ORE_TITANIUM_OW); registerRender(ORE_URANIUM_OW);
		 * registerRender(MINERAL_FIELD); registerRender(RICH_MINERAL_FIELD);
		 * registerRender(VESPENE_GEYSER); registerRender(RICH_VESPENE_GEYSER);
		 * registerRender(VESPENE_GEYSER_BASE);
		 * registerRender(DIM_PORTAL_OVERWORLD); registerRender(COMP_MINERAL);
		 * registerRender(CRYSTAL);
		 * 
		 * registerRender(ORE_ALIEN_CHAR); registerRender(ORE_COAL_CHAR);
		 * registerRender(ORE_COPPER_CHAR); registerRender(ORE_DIAMOND_CHAR);
		 * registerRender(ORE_GOLD_CHAR); registerRender(ORE_IRON_CHAR);
		 * registerRender(ORE_LAPIS_CHAR); registerRender(ORE_MINERAL_CHAR);
		 * registerRender(ORE_REDSTONE_CHAR);
		 * registerRender(ORE_RICHMINERAL_CHAR);
		 * registerRender(ORE_TITANIUM_CHAR); registerRender(ASH_CHAR);
		 * registerRender(DIRT_CHAR); registerRender(STONE_CHAR);
		 * registerRender(COBBLESTONE_CHAR);
		 * registerRender(VESPENE_GEYSER_CHAR);
		 * registerRender(RICH_VESPENE_GEYSER_CHAR);
		 * registerRender(VESPENE_GEYSER_BASE_CHAR); registerRender(MAGMA_CHAR);
		 ...
		 * registerRender(ORE_GOLD_SHAKURAS); registerRender(ORE_IRON_SHAKURAS);
		 ...
		 * registerRender(ORE_TITANIUM_SHAKURAS); registerRender(SAND_SHAKURAS);
		 * registerRender(STONE_SHAKURAS); registerRender(COBBLESTONE_SHAKURAS);
		 ...
		 * 
		 * registerRender(ENERGY_BLOCK); registerRender(VOID_ENERGY_BLOCK);
		 ...
		 * 
		 * registerRender(ZERG_CREEP); registerRender(KERATIN_CHUNK);
		 * registerRender(FLUID_ACID); registerRender(FLUID_BLOOD);
		 * 
		 * registerRender(COMP_METAL); registerRender(DYED_IRON);
		 */
	}
