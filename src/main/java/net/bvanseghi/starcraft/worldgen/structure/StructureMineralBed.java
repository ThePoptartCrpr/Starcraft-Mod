...
public class StructureMineralBed extends WorldGenerator {
	...
	public boolean LocationIsValidSpawn(World world, BlockPos pos) {
		...
		for (Block i : GetValidSpawnBlocks()) {
			...
			if (block == i) {
				...
				world.getBlockState(pos).getMaterial(); //Why are we calling this?
				return true;
			}
		}
		return false;
	...
	public boolean generate_r0(World world, Random rand, BlockPos pos) {
		...
		world.setBlockState(pos.add(x + 10, y + 0, z + 0), ModBlocks.MINERAL_FIELD.getDefaultState());
		world.setBlockState(pos.add(x + 0, y + 0, z + 1), ModBlocks.MINERAL_FIELD.getDefaultState());
		...
		world.setBlockState(pos.add(x + 7, y + 0, z + 1), ModBlocks.MINERAL_FIELD.getDefaultState());
		world.setBlockState(pos.add(x + 8, y + 0, z + 1), Blocks.AIR.getDefaultState());
		world.setBlockState(pos.add(x + 9, y + 0, z + 1), ModBlocks.MINERAL_FIELD.getDefaultState());
		world.setBlockState(pos.add(x + 10, y + 0, z + 1), ModBlocks.MINERAL_FIELD.getDefaultState());
		world.setBlockState(pos.add(x + 0, y + 0, z + 2), Blocks.AIR.getDefaultState());
		world.setBlockState(pos.add(x + 1, y + 0, z + 2), ModBlocks.MINERAL_FIELD.getDefaultState());
		world.setBlockState(pos.add(x + 2, y + 0, z + 2), Blocks.AIR.getDefaultState());
		world.setBlockState(pos.add(x + 3, y + 0, z + 2), ModBlocks.MINERAL_FIELD.getDefaultState());
		world.setBlockState(pos.add(x + 4, y + 0, z + 2), Blocks.AIR.getDefaultState());
		world.setBlockState(pos.add(x + 5, y + 0, z + 2), ModBlocks.MINERAL_FIELD.getDefaultState());
		...
		world.setBlockState(pos.add(x + 3, y + 0, z + 3), ModBlocks.MINERAL_FIELD.getDefaultState());
		world.setBlockState(pos.add(x + 4, y + 0, z + 3), ModBlocks.MINERAL_FIELD.getDefaultState());
		world.setBlockState(pos.add(x + 5, y + 0, z + 3), Blocks.AIR.getDefaultState());
		world.setBlockState(pos.add(x + 6, y + 0, z + 3), ModBlocks.MINERAL_FIELD.getDefaultState());
		world.setBlockState(pos.add(x + 7, y + 0, z + 3), Blocks.AIR.getDefaultState());
		world.setBlockState(pos.add(x + 8, y + 0, z + 3), ModBlocks.MINERAL_FIELD.getDefaultState());
