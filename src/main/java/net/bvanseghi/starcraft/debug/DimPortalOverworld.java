		...
		if (!entity.isRiding() && !entity.isBeingRidden() && !world.isRemote) {
			try {
				...
				if (player.dimension != this.dimOverworld) {
					...
					//TODO: you get it already
//					player.mcServer.getConfigurationManager().transferPlayerToDimension(player, this.dimOverworld, new ModTeleporter(player.mcServer.worldServerForDimension(this.dimOverworld)));
				}
