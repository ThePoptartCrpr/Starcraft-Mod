...
public class StructureVespeneGeyserShakuras extends WorldGenerator {
	...
	public boolean generate_r0(World world, Random rand, BlockPos pos) {
		...
		world.setBlockState(pos.add(x + 0, y + 0, z + 0), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 1, y + 0, z + 0), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 2, y + 0, z + 0), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 3, y + 0, z + 0), Blocks.AIR.getDefaultState());
		world.setBlockState(pos.add(x + 4, y + 0, z + 0), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 5, y + 0, z + 0), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 6, y + 0, z + 0), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 0, y + 0, z + 1), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 1, y + 0, z + 1), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 2, y + 0, z + 1), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 3, y + 0, z + 1), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 4, y + 0, z + 1), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 5, y + 0, z + 1), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 6, y + 0, z + 1), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 0, y + 0, z + 2), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 1, y + 0, z + 2), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 2, y + 0, z + 2), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 3, y + 0, z + 2), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 4, y + 0, z + 2), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 5, y + 0, z + 2), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 6, y + 0, z + 2), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 0, y + 0, z + 3), Blocks.AIR.getDefaultState());
		world.setBlockState(pos.add(x + 1, y + 0, z + 3), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 2, y + 0, z + 3), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 3, y + 0, z + 3), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 4, y + 0, z + 3), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 5, y + 0, z + 3), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		...
		world.setBlockState(pos.add(x + 1, y + 1, z + 1), ModBlocks.VESPENE_GEYSER_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 2, y + 1, z + 1), Blocks.AIR.getDefaultState());
		world.setBlockState(pos.add(x + 3, y + 1, z + 1), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 4, y + 1, z + 1), Blocks.AIR.getDefaultState());
		world.setBlockState(pos.add(x + 5, y + 1, z + 1), ModBlocks.VESPENE_GEYSER_SHAKURAS.getDefaultState());
		...
		world.setBlockState(pos.add(x + 2, y + 1, z + 2), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 3, y + 1, z + 2), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 4, y + 1, z + 2), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		...
		world.setBlockState(pos.add(x + 2, y + 1, z + 3), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 3, y + 1, z + 3), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		world.setBlockState(pos.add(x + 4, y + 1, z + 3), ModBlocks.VESPENE_GEYSER_BASE_SHAKURAS.getDefaultState());
		...
		world.setBlockState(pos.add(x + 3, y + 2, z + 2), ModBlocks.VESPENE_GEYSER_SHAKURAS.getDefaultState());
