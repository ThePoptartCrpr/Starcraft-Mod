...
<<<<<<< 9c53d1b268c91c7dd3e7b00933a509a597e4213d:src/main/java/ga/scmc/blocks/metablocks/BlockCompressedMetalsT1.java
=======
import scmc.blocks.ModBlocks;
import scmc.blocks.metablocks.EnumHandler.CompressedMetalType;
import scmc.lib.Reference;
>>>>>>> Start of proxy rebuild:src/main/java/scmc/blocks/metablocks/BlockCompressedMetalsT1.java

/**
 * This block has three variants. Refer to {@link CompressedMetalType}
 */
public class BlockCompressedMetalsT1 extends ModBlocks implements IMetaBlockName {
	...
	public BlockCompressedMetalsT1() {
		...
		setUnlocalizedName(Reference.ModBlocks.BLOCK_COMP_METALT1.getUnlocalizedName());
		setRegistryName(Reference.ModBlocks.BLOCK_COMP_METALT1.getRegistryRL());
